...
def test_ass_generator():
    ...
    config = {
        ...
        "style": {
            ...
            "heading": {"font": "Bailey", "size": 60, "color": "#FFD400"},
            "verse_number": {"show": True, "color": "#FFC080"},
        },
    }
    ...
    assert (
        "Style: Verse,Bailey,50,&H00FFFFFF,&H000000FF,&H00000000,&H4D000000,0,0,0,0,100,100,0,0,3,"
        in ass_content
    )
