...
2. **Audio Recordings** (e.g., `src/snd/42MRKSND.mpeg`, your studio-recorded narration audio)
3. **Verse-Level Timing Maps** (e.g., `src/snd/C01-01-MRK-05-timing.txt` generated by Scripture App Builder)
